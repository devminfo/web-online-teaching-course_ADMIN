...
export class ProvinceService {
  ...
  add(data: any): Observable<any> {
    const url = this.apiURL + '/provinces';
    return this.http
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/provinces/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: string) {
    return this.http
      .delete<any>(`${this.apiURL}/provinces/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/provinces/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/provinces/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
