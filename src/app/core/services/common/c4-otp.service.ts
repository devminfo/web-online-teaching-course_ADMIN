...
export class OtpService {
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/otps/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: string) {
    return this.http
      .delete<any>(`${this.apiURL}/otps/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/otps/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
