...
export class WardService {
  ...
  add(data: any): Observable<any> {
    const url = this.apiURL + '/villages';
    return this.http
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/villages/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: string) {
    return this.http
      .delete<any>(`${this.apiURL}/villages/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/villages/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/villages/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
