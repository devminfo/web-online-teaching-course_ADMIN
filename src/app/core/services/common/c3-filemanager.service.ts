...
export class FileManagerService {
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/file-manager')
  ...
  add(data: any): Observable<any> {
    const url = this.apiURL + '/file-manager';
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/file-manager/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: string) {
    return this.http
      .delete<any>(`${this.apiURL}/file-manager/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/file-manager/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/file-manager/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
