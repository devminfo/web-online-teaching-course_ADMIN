...
export class BackupService {
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/backup-datas')
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/backup-datas/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: string) {
    return this.http
      .delete<any>(`${this.apiURL}/backup-datas/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/backup-datas/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/backup-datas/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
