...
export class AuthUserAccessAPIService {
  // Define API
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/auth-user-accesses')
  ...
  add(data: any): Observable<any> {
    return this.http
      .post<any>(
        this.apiURL + '/auth-user-accesses',
        JSON.stringify(data),
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  update(id: any, data: any): Observable<any> {
    return this.http
      .put<any>(
        this.apiURL + '/auth-user-accesses/' + id,
        JSON.stringify(data),
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/auth-user-accesses/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(
        `${this.apiURL}/auth-user-accesses/${ids}/ids`,
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/auth-user-accesses/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
