...
export class AuthUserIdAPIService {
  // Define API
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/auth-user-ids')
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/auth-user-ids/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(`${this.apiURL}/auth-user-ids/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/auth-user-ids/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
