...
export class ReviewsService {
  ...
  updateStatus(id: any): Observable<any> {
    return this.http
      .put<any>(
        `${this.apiURL}/reviews/${id}/confirm-complain`,
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/reviews/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: string) {
    return this.http
      .delete<any>(`${this.apiURL}/reviews/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/reviews/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/reviews/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
