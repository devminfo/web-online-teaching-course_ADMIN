...
export class LectureService {
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/lectures/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(`${this.apiURL}/lectures/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/lectures/paginate?page=${params.page}&limit=${params.limit}&${params.filter}`;
