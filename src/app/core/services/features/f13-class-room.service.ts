...
export class ClassRoomService {
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/class-rooms')
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/class-rooms/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(`${this.apiURL}/class-rooms/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/class-rooms/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/class-rooms/paginate?page=${params.page}&limit=${params.limit}&${params.filter}`;
