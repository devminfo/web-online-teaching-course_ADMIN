...
export class PostService {
  ...
  add(data: any): Observable<any> {
    return this.http
      .post<any>(this.apiURL + '/posts', JSON.stringify(data), this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/posts/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(`${this.apiURL}/posts/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
