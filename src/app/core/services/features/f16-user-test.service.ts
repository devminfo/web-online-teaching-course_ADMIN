...
export class UserTestService {
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/user-tests')
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/user-tests/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(`${this.apiURL}/user-tests/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/user-tests/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/user-tests/paginate?page=${params.page}&limit=${params.limit}&${params.filter}`;
