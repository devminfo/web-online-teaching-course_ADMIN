...
export class GroupSService {
  ...
  get(filter = ''): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/group-services')
  ...
  detail(id: any, data: any): Observable<any> {
    return this.http
      .put<any>(
        this.apiURL + '/group-services/' + id,
        JSON.stringify(data),
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/group-services/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: string) {
    return this.http
      .delete<any>(`${this.apiURL}/group-services/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/group-services/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
...
=======
   * @param params
>>>>>>> bd298428fd79e994ce8335c2b6d9ced9d966bfa4
   * @returns
   */
  paginate(params: {
    page: number;
    ...
    let url = `${this.apiURL}/group-services/paginate?page=${params.page}&limit=${params.limit}&${params.filter}`;
