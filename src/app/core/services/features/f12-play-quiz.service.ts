...
export class PlayQuizService {
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/play-quizzes')
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/play-quizzes/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(`${this.apiURL}/play-quizzes/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/play-quizzes/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/play-quizzes/paginate?page=${params.page}&limit=${params.limit}&${params.filter}`;
