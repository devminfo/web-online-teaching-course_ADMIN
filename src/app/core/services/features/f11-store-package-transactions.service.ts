...
export class F11StorePackageTransactionsService {
...
get(): Observable<any> {
 return this.http
   .get<any>(this.apiURL + '/store-package-transactions')
...
add(data: any): Observable<any> {
 return this.http
   .post<any>(
     this.apiURL + '/store-package-transactions',
     JSON.stringify(data),
     this.httpOptions
   )
   .pipe(retry(1), catchError(this.handleError));
...
update(id: any, data: any): Observable<any> {
 return this.http
   .put<any>(
     this.apiURL + '/store-package-transactions/' + id,
     JSON.stringify(data),
     this.httpOptions
   )
   .pipe(retry(1), catchError(this.handleError));
...
delete(id: any) {
 return this.http
   .delete<any>(this.apiURL + '/store-package-transactions/' + id, this.httpOptions)
   .pipe(retry(1), catchError(this.handleError));
}
...
deleteManyByIds(ids: string) {
 return this.http
   .delete<any>(
     `${this.apiURL}/store-package-transactions/${ids}/ids`,
     this.httpOptions
   )
   .pipe(retry(1), catchError(this.handleError));
}
...
find(id: any): Observable<any> {
 return this.http
   .get<any>(this.apiURL + '/store-package-transactions/' + id)
   .pipe(retry(1), catchError(this.handleError));
}
...
paginate(params: {
  ...
  let url = `${this.apiURL}/store-package-transactions/paginate?page=${params.page}&populate=${params.populate}&limit=${params.limit}&filter=${params.filter}`;
