...
export class StoreSService {
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/store-services')
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/store-services/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(
        `${this.apiURL}/store-services/${ids}/ids`,
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/store-services/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/store-services/paginate?page=${params.page}&limit=${params.limit}&populate=${params.populate}&${params.filter}`;
