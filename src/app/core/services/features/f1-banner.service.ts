...
export class BannerService {
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/banners/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(`${this.apiURL}/sub-banners/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/banners/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
