...
export class F8VoucherTemplateDefaultService {
...
get(): Observable<any> {
  return this.http
    .get<any>(this.apiURL + '/voucher-template-defaults')
...
add(data: any): Observable<any> {
  return this.http
    .post<any>(
      this.apiURL + '/voucher-template-defaults',
      JSON.stringify(data),
      this.httpOptions
    )
    .pipe(retry(1), catchError(this.handleError));
...
update(id: any, data: any): Observable<any> {
  return this.http
    .put<any>(
      this.apiURL + '/voucher-template-defaults/' + id,
      JSON.stringify(data),
      this.httpOptions
    )
    .pipe(retry(1), catchError(this.handleError));
...
delete(id: any) {
  return this.http
    .delete<any>(this.apiURL + '/voucher-template-defaults/' + id, this.httpOptions)
    .pipe(retry(1), catchError(this.handleError));
}
...
deleteManyByIds(ids: string) {
  return this.http
    .delete<any>(
      `${this.apiURL}/voucher-template-defaults/${ids}/ids`,
      this.httpOptions
    )
    .pipe(retry(1), catchError(this.handleError));
}
...
find(id: any): Observable<any> {
  return this.http
    .get<any>(this.apiURL + '/voucher-template-defaults/' + id)
    .pipe(retry(1), catchError(this.handleError));
}
...
paginate(params: {
  ...
  let url = `${this.apiURL}/voucher-template-defaults/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
