...
export class SubSpecializeService {
  // Define API
   ...
   * @returns
   */
  get(params = { fields: '' }): Observable<any> {
    let url = this.apiURL + '/sub-specializes';
  ...
  update(id: any, data: any): Observable<any> {
    return this.http
      .put<any>(
        this.apiURL + '/sub-specializes/' + id,
        JSON.stringify(data),
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/sub-specializes/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(
        `${this.apiURL}/sub-specializes/${ids}/ids`,
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/sub-specializes/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
