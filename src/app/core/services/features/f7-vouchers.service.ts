...
export class F7VouchersService {
  // Define API
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/vouchers/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/vouchers/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/vouchers/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
  ...
  getValidVoucher(id:any):Observable<any> {
    return this.http
      .get<any>(`${this.apiURL}/vouchers/valid-vouchers?idStore=${id}&currentDateTime=1675641600000&numberOrder=100&populate=idStore&sort=priceDiscount`)
      .pipe(retry(1), catchError(this.handleError));
  }
  /*========================================
