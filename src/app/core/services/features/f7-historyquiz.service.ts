...
export class HistoryQuizService {
  // Define API
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/history-quizzes')
  ...
  update(id: any, data: any): Observable<any> {
    return this.http
      .put<any>(
        this.apiURL + '/history-quizzes/' + id,
        JSON.stringify(data),
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/history-quizzes/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: string) {
    return this.http
      .delete<any>(
        `${this.apiURL}/history-quizzes/${ids}/ids`,
        this.httpOptions
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/history-quizzes/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/history-quizzes/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
