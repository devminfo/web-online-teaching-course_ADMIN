...
export class CategoryService {
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/categories/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(`${this.apiURL}/categories/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/categories/paginate?page=${params.page}&limit=${params.limit}&${params.filter}`;
