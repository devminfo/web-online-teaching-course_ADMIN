...
export class CertificateService {
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/certificates')
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/certificates/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: string) {
    return this.http
      .delete<any>(`${this.apiURL}/certificates/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/certificates/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/certificates/paginate?page=${params.page}&limit=${params.limit}&${params.filter}`;
