...
export class F10AssetsPackagesService {
...
get(): Observable<any> {
 return this.http
   .get<any>(this.apiURL + '/assets-packages')
...
update(id: any, data: any): Observable<any> {
 return this.http
   .put<any>(
     this.apiURL + '/assets-packages/' + id,
     JSON.stringify(data),
     this.httpOptions
   )
   .pipe(retry(1), catchError(this.handleError));
...
delete(id: any) {
 return this.http
   .delete<any>(this.apiURL + '/assets-packages/' + id, this.httpOptions)
   .pipe(retry(1), catchError(this.handleError));
}
...
deleteManyByIds(ids: string) {
 return this.http
   .delete<any>(
     `${this.apiURL}/assets-packages/${ids}/ids`,
     this.httpOptions
   )
   .pipe(retry(1), catchError(this.handleError));
}
...
find(id: any): Observable<any> {
 return this.http
   .get<any>(this.apiURL + '/assets-packages/' + id)
   .pipe(retry(1), catchError(this.handleError));
}
...
paginate(params: {
  ...
  let url = `${this.apiURL}/assets-packages/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
