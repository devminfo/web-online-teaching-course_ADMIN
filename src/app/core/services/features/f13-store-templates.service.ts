...
export class F13StoreTemplatesService{
...
get(): Observable<any> {
 return this.http
   .get<any>(this.apiURL + '/store-templates')
...
update(id: any, data: any): Observable<any> {
 return this.http
   .put<any>(
     this.apiURL + '/store-templates/' + id,
     JSON.stringify(data),
     this.httpOptions
   )
   .pipe(retry(1), catchError(this.handleError));
...
delete(id: any) {
 return this.http
   .delete<any>(this.apiURL + '/store-templates/' + id, this.httpOptions)
   .pipe(retry(1), catchError(this.handleError));
}
...
deleteManyByIds(ids: string) {
 return this.http
   .delete<any>(
     `${this.apiURL}/store-templates/${ids}/ids`,
     this.httpOptions
   )
   .pipe(retry(1), catchError(this.handleError));
}
...
find(id: any): Observable<any> {
 return this.http
   .get<any>(this.apiURL + '/store-templates/' + id)
   .pipe(retry(1), catchError(this.handleError));
}
...
paginate(params: {
  ...
  let url = `${this.apiURL}/store-templates/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
