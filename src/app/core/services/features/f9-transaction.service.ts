...
export class TransactionService {
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/transactions')
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/transactions/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: string) {
    return this.http
      .delete<any>(`${this.apiURL}/transactions/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }

  /**
   * HttpClient API put() method => Update data rechargeMoney
   * @param money
   * @param idUser
   * @returns
   */
  rechargeMoney(money: number, idUser: any): Observable<any> {
    let url = this.apiURL + '/transactions/recharge-money';
  ...
  /**
   * HttpClient API put() method => Update data withdrawMoney
   * @param money
   * @param idUser
   * @returns
   */
  withdrawMoney(money: number, idUser: any): Observable<any> {
    let url = this.apiURL + '/transactions/withdraw-money';
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/transactions/paginate?page=${params.page}&limit=${params.limit}&filter=${params.filter}`;
