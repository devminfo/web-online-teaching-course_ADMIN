...
export class ConversationService {
  ...
  get(): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/conversations')
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/conversations/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(`${this.apiURL}/conversations/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/conversations/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/conversations/paginate?page=${params.page}&limit=${params.limit}&${params.filter}`;
