...
export class StoreService {
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/stores/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: string) {
    return this.http
      .delete<any>(`${this.apiURL}/stores/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/stores/paginate?page=${params.page}&limit=${params.limit}&populate=${params.populate}&filter=${params.filter}`;
