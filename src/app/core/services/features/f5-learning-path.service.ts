...
export class LearningPathService {
  ...
  delete(id: any) {
    return this.http
      .delete<any>(this.apiURL + '/learning-paths/' + id, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  deleteManyByIds(ids: any) {
    return this.http
      .delete<any>(`${this.apiURL}/learning-paths/${ids}/ids`, this.httpOptions)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  find(id: any): Observable<any> {
    return this.http
      .get<any>(this.apiURL + '/learning-paths/' + id)
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  paginate(params: {
    ...
    let url = `${this.apiURL}/learning-paths/paginate?page=${params.page}&limit=${params.limit}&${params.filter}`;
