...
import { OtpService } from 'src/app/core/services/common/c4-otp.service';
import { CommonService } from 'src/app/core/services/common.service';

@Component({
  selector: 'app-c4-otp',
  templateUrl: './c4-otp.component.html',
  styleUrls: ['./c4-otp.component.scss'],
})
export class C4OtpComponent implements OnInit, AfterViewInit, OnDestroy {
  // subscription
   ...
   */
  constructor(private commonService: CommonService, private api: OtpService) {
    // xử lý bất đồng bộ
    ...
    this.subscription.push(
      this.api
        .paginate({
          ...
          fields: 'email,phone,createdAt,_id',
          populate: '',
        })
        .subscribe((data) => {
