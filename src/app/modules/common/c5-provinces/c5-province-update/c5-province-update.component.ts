...
declare var $: any;
@Component({
  selector: 'app-c5-province-update',
  templateUrl: './c5-province-update.component.html',
  styleUrls: ['./c5-province-update.component.scss'],
})
export class C5ProvinceUpdateComponent
