...
import { FileManagerService } from 'src/app/core/services/common/c3-filemanager.service';
import { CommonService } from 'src/app/core/services/common.service';

@Component({
  selector: 'app-c3-filemanager',
  templateUrl: './c3-file-manager.component.html',
  styleUrls: ['./c3-file-manager.component.scss'],
})
export class C3FileManagerComponent
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  constructor(
    ...
    private api: FileManagerService
  ) {
    // xử lý bất đồng bộ
    ...
    this.subscription.push(
      this.api
        .paginate({
          ...
          fields:
            'size,owner.fullName,owner.email,owner.phone,storage,file,createdAt,type',
          populate: 'owner',
        })
        .subscribe((data) => {
          console.log(
