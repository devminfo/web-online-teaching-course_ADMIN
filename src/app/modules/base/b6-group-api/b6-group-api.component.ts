...
@Component({
  selector: 'app-b6-group-api',
  templateUrl: './b6-group-api.component.html',
  styleUrls: ['./b6-group-api.component.scss'],
})
export class B6GroupAPIComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  */
  ...
  onLoadDataGrid() {
    ...
    this.subscription.push(
      this.api.paginate(this.pageIndex, this.pageSize, filter)
        .subscribe((data) => {
