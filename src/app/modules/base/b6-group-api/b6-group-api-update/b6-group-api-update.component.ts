...
@Component({
  selector: 'app-b6-group-api-update',
  templateUrl: './b6-group-api-update.component.html',
  styleUrls: ['./b6-group-api-update.component.scss'],
})
export class B6GroupAPIUpdateComponent
