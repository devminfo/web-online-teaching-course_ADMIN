...
@Component({
  selector: 'auth-user-id',
  templateUrl: './b5-auth-user-id.component.html',
  styleUrls: ['./b5-auth-user-id.component.scss'],
})
export class B5AuthUserIdComponent implements OnInit, AfterViewInit, OnDestroy {
  // subscription
    ...
    this.subscription.push(
      this.api
        .paginate({
          page: this.pageIndex,
          limit: this.pageSize,
          fields: 'accessMethods,url,collectionName,createdAt,referId',
          filter: '',
        })
        .subscribe((data) => {
