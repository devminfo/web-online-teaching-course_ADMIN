...
@Component({
  selector: 'app-b3-free-api',
  templateUrl: './b3-free-api.component.html',
  styleUrls: ['./b3-free-api.component.scss'],
})
export class B3FreeAPIComponent implements OnInit, AfterViewInit, OnDestroy {
  // subscription
