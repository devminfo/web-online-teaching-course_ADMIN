...
@Component({
  selector: 'app-b7-group-detail-add',
  templateUrl: './b7-group-detail-add.component.html',
  styleUrls: ['./b7-group-detail-add.component.scss'],
})
export class B7GroupDetailAddComponent
