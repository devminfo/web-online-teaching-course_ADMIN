...
@Component({
  selector: 'b4-auth-user-access-update',
  templateUrl: './b4-auth-user-access-update.component.html',
  styleUrls: ['./b4-auth-user-access-update.component.scss'],
})
export class B4AuthUserAccessUpdateComponent
  implements OnInit, AfterViewInit, OnDestroy
{
   ...
   */
  constructor(
    private api: AuthUserAccessAPIService,
    ...
    if (!this.form.invalid) {
      ...
      this.subscription.push(
        this.api.update(this.id, this.input).subscribe(() => {
          ...
          // redirect to list
          this.router.navigate(['/features/authuseraccesses']);
        })
      );
    }
  }
