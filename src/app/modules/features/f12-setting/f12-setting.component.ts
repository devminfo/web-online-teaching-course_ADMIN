...
@Component({
  selector: 'app-f12-setting',
  templateUrl: './f12-setting.component.html',
  styleUrls: ['./f12-setting.component.scss'],
})
export class F12SettingComponent implements OnInit, AfterViewInit, OnDestroy {
  // subscription
    ...
    this.subscription.push(
      this.api
        .paginate({
          ...
          fields:
            'bankName,branchName,bankAccountNumber,bankAccountName,phone,momo,vnPay,quizPassPercent,shareContent,policyContent,feeAppPercent,logo',
        })
        .subscribe((data) => {
