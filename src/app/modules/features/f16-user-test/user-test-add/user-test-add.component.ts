...
@Component({
  selector: 'app-user-test-add',
  templateUrl: './user-test-add.component.html',
  styleUrls: ['./user-test-add.component.scss'],
})
export class UserTestAddComponent implements OnInit, AfterViewInit, OnDestroy {
  // subscription
