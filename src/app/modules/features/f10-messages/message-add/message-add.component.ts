...
import { MessageService } from 'src/app/core/services/features/f10-message.service';
...
export class MessageAddComponent implements OnInit, AfterViewInit, OnDestroy {
  // subscription
    ...
    if (!this.form.invalid) {
      ...
      this.subscription.push(
        this.api.add(this.input).subscribe(() => {
          ...
          // redirect to list
          this.router.navigate(['/features/messages']);
        })
      );
    }
  }
