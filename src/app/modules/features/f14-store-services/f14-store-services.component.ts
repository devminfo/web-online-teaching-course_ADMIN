...
@Component({
  selector: 'app-f14-store-services',
  templateUrl: './f14-store-services.component.html',
  styleUrls: ['./f14-store-services.component.scss'],
})
export class F14StoreServicesComponent
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  ngOnInit() {
    ...
    // check local store
    const checkLocalStore = localStorage.getItem('isCheckStoreService');
    if(checkLocalStore){
      this.checkData = JSON.parse(checkLocalStore);
    }
  }
