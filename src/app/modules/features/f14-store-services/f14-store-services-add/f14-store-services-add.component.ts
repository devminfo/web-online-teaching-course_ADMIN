...
@Component({
  selector: 'app-f14-store-services-add',
  templateUrl: './f14-store-services-add.component.html',
  styleUrls: ['./f14-store-services-add.component.scss'],
})
export class F14StoreServicesAddComponent
