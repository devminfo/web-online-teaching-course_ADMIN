...
@Component({
  selector: 'app-f14-store-services-update',
  templateUrl: './f14-store-services-update.component.html',
  styleUrls: ['./f14-store-services-update.component.scss'],
})
export class F14StoreServicesUpdateComponent
        ...
        this.common.comfirmImages(images).subscribe((data) => {
          ...
          this.subscription.push(
            this.api.update(this.id, this.input).subscribe(() => {
              ...
              localStorage.setItem('isCheckStoreService', JSON.stringify(this.isCheckStoreService))
