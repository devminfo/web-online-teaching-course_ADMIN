...
@Component({
  selector: 'app-f4-subject',
  templateUrl: './f4-subject.component.html',
  styleUrls: ['./f4-subject.component.scss'],
})
export class F4SubjectComponent implements OnInit, AfterViewInit, OnDestroy {
  // subscription
