...
export const environment = {
  ...
  appPreviewDocsUrl: 'https://preview.keenthemes.com/html/metronic/docs/index',
  appPreviewChangelogUrl: 'https://preview.keenthemes.com/html/metronic/docs/index/changelog',
  appDemos: {
    'demo1': {
      'title': 'Demo 1',
